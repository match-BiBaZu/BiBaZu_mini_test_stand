    ...
    internal sealed class NdjsonForceServer : IDisposable
    {
        ...
        public void Publish(FilteredSample sample)
        {
            ...
            string line = JsonConvert.SerializeObject(new
            {
                ...
                force_1_n = sample.FastForce1N,
                force_2_n = sample.FastForce2N,
                force_total_n = sample.FastForceTotalN,
                force_1_mean_20_n = sample.FastForce1N,
                force_2_mean_20_n = sample.FastForce2N,
                force_total_mean_20_n = sample.FastForceTotalN,
                force_1_raw_n = sample.RawForce1N,
                force_2_raw_n = sample.RawForce2N,
                force_total_raw_n = sample.RawForceTotalN,
                status = "ok",
                channel_1_status = "ok",
                channel_2_status = "ok"
            }) + "\n";
