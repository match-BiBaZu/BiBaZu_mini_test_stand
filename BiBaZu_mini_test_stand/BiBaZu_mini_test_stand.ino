...
const int testRepeatWaitTicks = 399;          // 999 + 1 ticks at 5 ms = 5.0 s.
const int testPressureStepWaitTicks = 999;   // 1999 + 1 ticks at 5 ms = 10.0 s after a pressure increase.
